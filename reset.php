...
<div class="shadow-lg p-3 mb-5 bg-white rounded" style="margin-top:9%; margin-left: 40%; height: 250px; width: 250px;">

  <form class="col-md-12" method="POST" action=""> 
    <h3 class="text-warning pt-3 title mx-auto">Reset password</h3>
