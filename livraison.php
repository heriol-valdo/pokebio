...
while ($row = mysqli_fetch_array($result)) {
    ...
    $id = rtrim($id, ", ");
    echo "<tr><td colspan='3' class='text-center'>Promo Code</td><td><input 
   class='form-control' placeholder='enter the code if you have one' type='number' size='5'></td></tr>";

    echo "<tr><td></td><td>Total</td><td>Eu " . $sum . "</td><td><a href='livraison.php' class='btn btn-primary'  >Confirm Order</a></td></tr>";
    ?>
                            </tbody>
                            <?php
} else {
